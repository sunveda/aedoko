...
export default function Home() {
  ...
  return (
    <main className="app-shell">
      ...
      <section className="trust-row" aria-label="Coverage details"><p>{t.varies}</p><p><strong>{sourcedCount} / 62</strong> {t.sourced}</p><p><strong>{validCount}</strong> {t.validated}</p></section>
